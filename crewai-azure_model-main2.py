...
default_llm = AzureChatOpenAI(
    ...
    azure_endpoint=os.environ.get("AZURE_OPENAI_ENDPOINT", "https://voss-gpt-eastus2.openai.azure.com"),
    api_key=os.environ.get("AZURE_OPENAI_KEY", "836e032e538f4d54813878859e926981")
)
